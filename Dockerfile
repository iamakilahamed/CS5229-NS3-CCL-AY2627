...
##
## Modified by Jin Yuze for NUS CS5229 Assignment
## ******************************************************************************

## Use Ubuntu
FROM ubuntu:22.04

## The original authors of Astra-Sim:
LABEL maintainer="Will Won <william.won@gatech.edu>"
LABEL maintainer="Jinsun Yoo <jinsun@gatech.edu>"

## The maintainer for CS5229 Assignment:
LABEL maintainer="Jin Yuze <jin.yuze@u.nus.edu>"
