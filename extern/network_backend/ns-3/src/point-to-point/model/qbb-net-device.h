...
// This class is used for hosts, switch doesn't use it. 
...
protected:
   ...
   */
  // This m_queue is only used by switch.
  Ptr<BEgressQueue> m_queue;
  // Ptr<Queue<Packet>> m_queue;
  // TODO: use a more general queue definition
...
public:
  // This RDMA EQ is only used by hosts. 
